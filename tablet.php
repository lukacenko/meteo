...
<td class="aktualizace">Dátum a čas poslednej aktualizácie: <?php echo date("d-m");  echo '  o '.$aktualna_teplota_teraz[0]['cas']. ' hod'?></td>
<td class="log">
<?php
if(isset($_GET['od'])){
...
<div id="zahlavi">
		...
		<div id="aktualniHodnoty" style="width:995px">
